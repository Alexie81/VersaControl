...
namespace VersaControl.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<VersaControl.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<VersaControl.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(VersaControl.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(VersaControl.Server.Models.ApplicationUser user)
        {
            try
            {
