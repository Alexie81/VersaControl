...
{
    public partial class AddTipuriContract
    {
        [Inject]
        ...
        {
            tipuriContract = new VersaControl.Server.Models.versacontrol.TipuriContract();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await versacontrolService.CreateTipuriContract(tipuriContract);
