...
namespace VersaControl.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<VersaControl.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(VersaControl.Server.Models.ApplicationRole role)
        {
            try
            {
