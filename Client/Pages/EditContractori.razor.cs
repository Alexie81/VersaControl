...
{
    public partial class EditContractori
    {
        [Inject]
        ...
        {
            contractori = await versacontrolService.GetContractoriById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await versacontrolService.UpdateContractori(id:Id, contractori);
